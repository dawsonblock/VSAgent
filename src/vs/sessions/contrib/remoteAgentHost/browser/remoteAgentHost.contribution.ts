...
import { AgentHostToolConfirmationSource, IAgentHostToolConfirmationResolverService } from '../../../../workbench/contrib/chat/browser/agentSessions/agentHost/agentHostToolConfirmationResolverService.js';
...
export class RemoteAgentHostContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		@IAgentHostToolConfirmationResolverService private readonly _toolConfirmationResolverService: IAgentHostToolConfirmationResolverService,
	) {
		super();
	...
	private _registerAgent(address: string, loggedConnection: LoggingAgentConnection, agent: IAgentInfo, configuredName: string | undefined): void {
		...
		const sessionHandler = agentStore.add(this._instantiationService.createInstance(
			...
			resolveToolConfirmation: request => this._toolConfirmationResolverService.resolveToolConfirmation({
				...request,

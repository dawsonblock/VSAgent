...
export interface ISessionsProviderCapabilities {
	...
	/** Where this provider primarily hosts execution. */
	readonly hostKind: SessionHostKind;
	/** Whether the provider may read workspace content through Sessions mediation. */
	readonly canReadWorkspace: boolean;
	/** Whether the provider may write workspace content through Sessions mediation. */
...
export interface ISessionsProvider {
	...
	/** Optional per-session capability refinement. */
